...
function buildInvoiceHTML({
  ...
  const isCarriedForwardHtml = shiftedAmount > 0;
  const isPaidHtml = amountPending === 0 && !isCarriedForwardHtml;

  const statusBar = isCarriedForwardHtml
    ? `
    <div style="display:flex; align-items:center; justify-content:space-between; background:#fff7ed; border:1px solid #fed7aa; border-radius:10px; padding:12px 16px;">
      <div style="display:flex; align-items:center; gap:12px;">
        ...
        <div>
          ...
          <p style="margin:2px 0 0; color:#c2410c; font-size:12px;">PKR ${shiftedAmount.toLocaleString()} was moved to the next cycle.</p>
        </div>
      </div>
...
<body>
  ...
  <div style="margin-top:28px; padding-top:12px; border-top:1px solid #e5e7eb; text-align:center;">
    ...
    <p style="font-size:10px; color:#d1d5db; margin-top:3px;">This is a computer-generated invoice — no signature required.</p>
  </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-orange-600">
                      PKR {Number(cycle.shiftedAmount).toLocaleString()} was
