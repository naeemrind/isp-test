...
//     // inventory-dues = subscriber has unpaid inventory balance
...
//                                     : f.id === "inventory-dues"
//                                       ? "Subscribers with unpaid hardware/equipment dues"
//                                       : ""
//                     }
...
// // ─── Inventory Dues View ───────────────────────────────────────────────────────
// // Rich card view shown when the "Inventory Dues" filter is active.
// // Shows each subscriber who has unpaid inventory jobs with full detail.

// function InventoryDuesView({ customers, jobs, onPay }) {
...
//     return (
//       <div className="bg-white border border-gray-200 rounded-xl p-10 flex flex-col items-center justify-center gap-3 text-center">
...
//   const grandTotal = dueCustomers.reduce((sum, c) => {
//     return (
//       sum +
//       (pendingJobsByCustomer[c.id] || []).reduce(
...
//             {dueCustomers.length} subscriber
//             {dueCustomers.length !== 1 ? "s" : ""} with unpaid inventory
//           </span>
//         </div>
...
//         const pendingJobs = pendingJobsByCustomer[customer.id] || [];
...
//           0,
//         );
//         const totalPaid = pendingJobs.reduce(
//           (s, j) => s + (j.amountPaid || 0),
//           0,
//         );
...
//           <div
//             key={customer.id}
//             className="bg-white border border-purple-100 rounded-xl overflow-hidden shadow-sm"
//           >
//             {/* Subscriber header */}
...
//                     {customer.mainArea || "—"} · {pendingJobs.length} pending
//                     job{pendingJobs.length !== 1 ? "s" : ""}
//                   </div>
//                 </div>
//               </div>
...
//                           <span
//                             key={i}
//                             className="inline-flex items-center gap-1 text-[11px] bg-gray-100 text-gray-700 rounded px-2 py-0.5 font-medium"
//                           >
//                             {item.description}
...
//                     {/* Payment summary */}
//                     <div className="text-right shrink-0 space-y-0.5 min-w-32">
...
//                           Paid: PKR {job.amountPaid.toLocaleString()}
//                         </div>
//                       )}
//                       <div className="text-[11px] font-bold text-red-600 bg-red-50 rounded px-1.5 py-0.5 inline-block">
//                         Due: PKR {(job.amountPending || 0).toLocaleString()}
//                       </div>
//                     </div>
//                   </div>
//                 </div>
...
//             {/* Footer summary for this subscriber */}
//             {pendingJobs.length > 1 && (
//               <div className="flex items-center justify-between px-4 py-2.5 bg-gray-50 border-t border-gray-100 text-xs">
//                 <span className="text-gray-500">
//                   Issued: PKR {totalIssued.toLocaleString()} · Paid: PKR{" "}
//                   {totalPaid.toLocaleString()}
//                 </span>
//                 <span className="font-bold text-red-600">
//                   Outstanding: PKR {totalPending.toLocaleString()}
//                 </span>
//               </div>
//             )}
//           </div>
...
// ===================================================
// Above Code provided by Claude
// // Below Code provided by Google AI Studio,
              ...
              {pendingJobs.map((job) => (
                <div key={job.id} className="px-4 py-3">
                  <div className="flex items-start justify-between gap-3">
                    ...
                    {/* Payment summary */}
                    <div className="text-right shrink-0 flex flex-col items-end gap-1 min-w-32">
                      ...
                      {(job.amountPending || 0) > 0 && (
                        <button
                          ...
                          className="mt-1 px-3 py-1 text-[11px] bg-blue-600 text-white rounded-md hover:bg-blue-700 font-medium transition-colors shadow-sm"
                        >
                          Pay Dues
                        </button>
                      )}
